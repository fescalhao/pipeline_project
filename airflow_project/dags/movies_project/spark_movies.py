...
from dag_utils.spark_app_template.builder import build_spark_app_template
from movies_project.movie_utils import get_spark_arguments
...
with DAG(
    ...
    for entity in entities:
        ...
        SparkKubernetesOperator(
            task_id=f"spark_movies_{movies_silver_var.get('layer')}_{movies_silver_var.get('entity')}_task",
            namespace="default",
